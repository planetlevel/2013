...
<Project Type="Project" LVVersion="12008004">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.17.19.2</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="Team Code" Type="Folder">
			<Item Name="Begin" Type="Folder">
				<Item Name="BeginDrive.vi" Type="VI" URL="../BeginDrive.vi"/>
				<Item Name="BeginJoysticks.vi" Type="VI" URL="../BeginJoysticks.vi"/>
				<Item Name="BeginCamera.vi" Type="VI" URL="../BeginCamera.vi"/>
				<Item Name="BeginShooter.vi" Type="VI" URL="../BeginShooter.vi"/>
				<Item Name="BeginClimber.vi" Type="VI" URL="../BeginClimber.vi"/>
				<Item Name="BeginTipper.vi" Type="VI" URL="../BeginTipper.vi"/>
				<Item Name="BeginTilter.vi" Type="VI" URL="../BeginTilter.vi"/>
				<Item Name="BeginCompressor.vi" Type="VI" URL="../BeginCompressor.vi"/>
			</Item>
			<Item Name="Test" Type="Folder">
				<Item Name="Drive Test.vi" Type="VI" URL="../Drive Test.vi"/>
				<Item Name="Driver Encoder Validater.vi" Type="VI" URL="../Driver Encoder Validater.vi"/>
				<Item Name="ShooterMotorAndEncoderTest.vi" Type="VI" URL="../ShooterMotorAndEncoderTest.vi"/>
				<Item Name="Injection Test.vi" Type="VI" URL="../Injection Test.vi"/>
				<Item Name="Limit Switch Test.vi" Type="VI" URL="../Limit Switch Test.vi"/>
				<Item Name="Aiming Mechanism Test.vi" Type="VI" URL="../Aiming Mechanism Test.vi"/>
				<Item Name="ClimberTest.vi" Type="VI" URL="../ClimberTest.vi"/>
				<Item Name="Tipping Device Test.vi" Type="VI" URL="../Tipping Device Test.vi"/>
			</Item>
			<Item Name="aimHorizontal.vi" Type="VI" URL="../aimHorizontal.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="ApplyDeadband.vi" Type="VI" URL="../ApplyDeadband.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="Calculate_MecanumDrive.vi" Type="VI" URL="../Calculate_MecanumDrive.vi"/>
			<Item Name="Climb.vi" Type="VI" URL="../Climb.vi"/>
			<Item Name="ClimberGoToSwitch.vi" Type="VI" URL="../ClimberGoToSwitch.vi"/>
			<Item Name="ClimberLimitSwitches.ctl" Type="VI" URL="../ClimberLimitSwitches.ctl"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="getMotorAndEncoder.vi" Type="VI" URL="../getMotorAndEncoder.vi"/>
			<Item Name="Mecanum Drive with PID.vi" Type="VI" URL="../Mecanum Drive with PID.vi"/>
			<Item Name="OpenMotorAndEncoder.vi" Type="VI" URL="../OpenMotorAndEncoder.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="RequestTargetInfo.vi" Type="VI" URL="../RequestTargetInfo.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="SetMotorWithPID.vi" Type="VI" URL="../SetMotorWithPID.vi"/>
			<Item Name="Shoot.vi" Type="VI" URL="../Shoot.vi"/>
			<Item Name="Shooter Injection.vi" Type="VI" URL="../Shooter Injection.vi"/>
			<Item Name="Shooter Tilter.vi" Type="VI" URL="../Shooter Tilter.vi"/>
			<Item Name="TargetData.ctl" Type="VI" URL="../TargetData.ctl"/>
			<Item Name="Tipping Mechanism.vi" Type="VI" URL="../Tipping Mechanism.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="UserInterface.vi" Type="VI" URL="../UserInterface.vi"/>
			<Item Name="Pneumatic Test.vi" Type="VI" URL="../Pneumatic Test.vi"/>
			<Item Name="Vision Global Data.vi" Type="VI" URL="../Vision Global Data.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="Shooter Tilter Auto Manual.vi" Type="VI" URL="../Shooter Tilter Auto Manual.vi"/>
			<Item Name="Shooting Motor Start Stop.vi" Type="VI" URL="../Shooting Motor Start Stop.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="ClimberControl.vi" Type="VI" URL="../ClimberControl.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Rectangular Target - 2013.vi" Type="VI" URL="../Rectangular Target.vi/Rectangular Target - 2013.vi"/>
			<Item Name="nivision.dll" Type="Document" URL="nivision.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Draw Filled Rect.vi" Type="VI" URL="../Rectangular Target.vi/Draw Filled Rect.vi"/>
			<Item Name="Compute Distance.vi" Type="VI" URL="../Rectangular Target.vi/Compute Distance.vi"/>
			<Item Name="Score Particles.vi" Type="VI" URL="../Rectangular Target.vi/Score Particles.vi"/>
			<Item Name="Sorted Particle Report.vi" Type="VI" URL="../Rectangular Target.vi/Sorted Particle Report.vi"/>
			<Item Name="Aspect Ratio Score.vi" Type="VI" URL="../Rectangular Target.vi/Aspect Ratio Score.vi"/>
			<Item Name="Rectangularity Score.vi" Type="VI" URL="../Rectangular Target.vi/Rectangularity Score.vi"/>
			<Item Name="Normalized Range Compare.vi" Type="VI" URL="../Rectangular Target.vi/Normalized Range Compare.vi"/>
			<Item Name="Compute HSL Color Ranges.vi" Type="VI" URL="../Rectangular Target.vi/Compute HSL Color Ranges.vi"/>
			<Item Name="WPI_UtilitiesFRCAutomaticValuePublisher.vi" Type="VI" URL="../WPI_UtilitiesFRCAutomaticValuePublisher.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/FRC2013/RobotCode/V1/Builds</Property>
